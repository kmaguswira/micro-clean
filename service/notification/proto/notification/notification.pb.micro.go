...
func (x *notificationServiceStream) Context() context.Context {
...
func (x *notificationServicePingPong) Context() context.Context {
	return x.stream.Context()
}
...
func (x *notificationStreamStream) Context() context.Context {
	return x.stream.Context()
}
...
func (x *notificationPingPongStream) Context() context.Context {
	return x.stream.Context()
}
