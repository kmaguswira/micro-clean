...
func (x *fileServiceStream) Context() context.Context {
...
func (x *fileServicePingPong) Context() context.Context {
	return x.stream.Context()
}
...
func (x *fileStreamStream) Context() context.Context {
	return x.stream.Context()
}
...
func (x *filePingPongStream) Context() context.Context {
	return x.stream.Context()
}
